...
#ifndef VAOPENAL_LISTENER
#define VAOPENAL_LISTENER
...
#include <vaOpenal/SoundStream.h>
...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    static void SetPosition(const osg::Vec3f& Position);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static void SetTarget(const osg::Vec3f& Target);
    ...
    static std::vector<Sound*> soundPool;
    static std::vector<SoundStream*> streamPool;
};
