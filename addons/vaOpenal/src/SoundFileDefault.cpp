...
// Headers
////////////////////////////////////////////////////////////
#include <vaOpenal/SoundFileDefault.h>
#include <iostream>
#include <string.h>
        ...
        else
        {
            switch(sf_error(File))
            {
                case SF_ERR_UNRECOGNISED_FORMAT:
                    osg::notify(osg::FATAL)<<"SoundPlayer, unrecognised format"<<std::endl;        
                    break;
                case SF_ERR_SYSTEM:
                    osg::notify(osg::FATAL)<<"SoundPlayer, system error"<<std::endl;        
                    break;
                case SF_ERR_MALFORMED_FILE:
                    osg::notify(osg::FATAL)<<"SoundPlayer, malformed file"<<std::endl;        
                    break;
                case SF_ERR_UNSUPPORTED_ENCODING:
                    osg::notify(osg::FATAL)<<"SoundPlayer, unsupported encoding"<<std::endl;        
                    break;
                default:
                    osg::notify(osg::FATAL)<<"SoundPlayer, unknown error"<<std::endl;        
                    break;
            };
            return false;
        }
