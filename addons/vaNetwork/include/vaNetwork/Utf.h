...
#ifndef VANETWORK_UTF
#define VANETWORK_UTF
...
public :
    ...
    /// specializations of the vaNetwork::Utf<> template, and allow
...
public :
    ...
    /// of vaNetwork::Utf<>, it is defined for convenience (it is used by
...
///
/// vaNetwork::Utf is a low-level, generic interface for counting, iterating,
/// encoding and decoding Unicode characters and strings. It is able
/// to handle ANSI, wide, UTF-8, UTF-16 and UTF-32 encodings.
///
/// vaNetwork::Utf<X> functions are all static, these classes are not meant to
/// be instanciated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li vaNetwork::Utf<8> (typedef'd to vaNetwork::Utf8)
/// \li vaNetwork::Utf<16> (typedef'd to vaNetwork::Utf16)
/// \li vaNetwork::Utf<32> (typedef'd to vaNetwork::Utf32)
///
////////////////////////////////////////////////////////////
