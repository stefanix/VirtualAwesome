...
#ifndef VANETWORK_FTP
#define VANETWORK_FTP
...
/// \ingroup network
///
/// vaNetwork::Ftp is a very simple FTP client that allows you
...
/// vaNetwork::Ftp::Response to provide this data.
///
...
/// vaNetwork::Ftp::Response response = ftp.Connect("ftp://ftp.myserver.com");
/// if (response.IsOk())
...
/// vaNetwork::Ftp::DirectoryResponse directory = ftp.GetWorkingDirectory();
/// if (directory.IsOk())
...
/// response = ftp.Upload("local-path/file.txt", "files", vaNetwork::Ftp::Ascii);
/// if (response.IsOk())
