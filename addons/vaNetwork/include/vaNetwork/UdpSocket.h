...
#ifndef VANETWORK_UDPSOCKET
#define VANETWORK_UDPSOCKET
...
///
/// The high-level interface uses packets (see vaNetwork::Packet),
/// which are easier to use and provide more safety regarding
/// the data that is exchanged. You can look at the vaNetwork::Packet
...
/// vaNetwork::UdpSocket socket;
/// socket.Bind(55001);
///
/// // Send a message to 192.168.1.50 on port 55002
/// std::string message = "Hi, I am " + vaNetwork::IpAddress::GetLocalAddress().ToString();
...
/// \endcode
///
/// \see vaNetwork::Socket, vaNetwork::TcpSocket, vaNetwork::Packet
///
////////////////////////////////////////////////////////////
