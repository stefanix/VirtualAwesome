...
#ifndef VANETWORK_STRING
#define VANETWORK_STRING
...
////////////////////////////////////////////////////////////
/// \class vaNetwork::String
/// \ingroup system
///
/// vaNetwork::String is a utility string class defined mainly for
...
/// s = vaNetwork::String("hello", locale);
/// \endcode
///
/// vaNetwork::String defines the most important functions of the
/// standard std::string class: removing, random access, iterating,
/// appending, comparing, etc. However it is a simple class
/// provided for convenience, and you may have to consider using
/// a more optimized class if your program requires complex string
/// handling. The automatic conversion functions will then take
/// care of converting your string to vaNetwork::String whenever SFML
/// requires it.
///
/// Please note that SFML also defines a low-level, generic
/// interface for Unicode handling, see the vaNetwork::Utf classes.
///
////////////////////////////////////////////////////////////
